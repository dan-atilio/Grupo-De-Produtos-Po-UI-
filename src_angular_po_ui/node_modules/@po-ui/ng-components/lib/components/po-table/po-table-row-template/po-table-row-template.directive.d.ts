...
export declare class PoTableRowTemplateDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTableRowTemplateDirective, "[p-table-row-template]", never, { "poTableRowTemplateShow": { "alias": "p-table-row-template-show"; "required": false; }; "tableRowTemplateArrowDirection": { "alias": "p-table-row-template-arrow-direction"; "required": false; }; }, {}, never, never, false, never>;
}
