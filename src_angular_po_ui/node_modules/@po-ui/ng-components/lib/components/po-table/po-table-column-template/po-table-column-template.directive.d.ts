...
export declare class PoTableColumnTemplateDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTableColumnTemplateDirective, "[p-table-column-template]", never, { "targetProperty": { "alias": "p-property"; "required": false; }; }, {}, never, never, false, never>;
}
