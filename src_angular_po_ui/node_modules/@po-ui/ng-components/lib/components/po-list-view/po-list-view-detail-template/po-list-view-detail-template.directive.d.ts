...
export declare class PoListViewDetailTemplateDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoListViewDetailTemplateDirective, "[p-list-view-detail-template]", never, { "showDetail": { "alias": "p-show-detail"; "required": false; }; }, {}, never, never, false, never>;
}
