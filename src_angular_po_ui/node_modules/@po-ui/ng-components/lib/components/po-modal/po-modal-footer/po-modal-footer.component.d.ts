...
export declare class PoModalFooterComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoModalFooterComponent, "po-modal-footer", never, { "disabledAlign": { "alias": "p-disabled-align"; "required": false; }; }, {}, never, ["*"], false, never>;
}
