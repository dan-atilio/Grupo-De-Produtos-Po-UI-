...
export declare class PoLinkBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoLinkBaseComponent, never, never, { "label": { "alias": "p-label"; "required": false; }; "openNewTab": { "alias": "p-open-new-tab"; "required": false; }; "url": { "alias": "p-url"; "required": false; }; }, { "action": "p-action"; }, never, never, false, never>;
    static ngAcceptInputType_openNewTab: any;
}
