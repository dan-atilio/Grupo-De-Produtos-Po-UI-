 ...
 */
export declare class PoImageBaseComponent {
    isBase64: boolean;
    private _source;
    /**
     * @optional
     ...
     */
    loading?: PoImageLoading;
    static ɵfac: i0.ɵɵFactoryDeclaration<PoImageBaseComponent, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoImageBaseComponent, never, never, { "height": { "alias": "p-height"; "required": false; }; "alternate": { "alias": "p-alt"; "required": false; }; "source": { "alias": "p-src"; "required": false; }; "priority": { "alias": "p-priority"; "required": false; }; "loading": { "alias": "p-loading"; "required": false; }; }, {}, never, never, false, never>;
}
export {};
