...
export declare class PoStepComponent implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoStepComponent, "po-step", never, { "canActiveNextStep": { "alias": "p-can-active-next-step"; "required": false; }; "label": { "alias": "p-label"; "required": false; }; "status": { "alias": "p-status"; "required": false; }; }, {}, never, ["*"], false, never>;
}
