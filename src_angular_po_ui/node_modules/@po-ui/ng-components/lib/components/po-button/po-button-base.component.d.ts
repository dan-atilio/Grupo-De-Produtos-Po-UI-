...
export declare class PoButtonBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoButtonBaseComponent, never, never, { "label": { "alias": "p-label"; "required": false; }; "icon": { "alias": "p-icon"; "required": false; }; "loading": { "alias": "p-loading"; "required": false; }; "danger": { "alias": "p-danger"; "required": false; }; "size": { "alias": "p-size"; "required": false; }; "kind": { "alias": "p-kind"; "required": false; }; "disabled": { "alias": "p-disabled"; "required": false; }; "ariaLabel": { "alias": "p-aria-label"; "required": false; }; }, { "click": "p-click"; }, never, never, false, never>;
