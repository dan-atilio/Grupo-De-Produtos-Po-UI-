...
export declare class PoPageJobSchedulerBaseComponent implements OnDestroy {
     ...
     *
     */
    set stepperDefaultOrientation(value: PoStepperOrientation);
     ...
     * ```
     */
    beforeSendAction: (model: PoJobSchedulerInternal) => PoJobSchedulerInternal;
    /**
     * @optional
     *
     * @description
